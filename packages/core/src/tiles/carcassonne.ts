...
export const carcassonne: { [key: string]: Tile } = {
  ...
  //   right: TileComponent.ROAD,
  //   bottom: TileComponent.EMPTY,
  //   left: TileComponent.ROAD,
  //   monastary: false,
  // },
  // 1: {
  //   //3
